...
class isic_loader(Dataset):
    ...
    def __init__(self, path_Data, train=True, Test=False, transform=None):
    ...
    def __getitem__(self, indx):
        ...
        # Permute to match the expected format (C, H, W)
        img = img.permute(2, 0, 1)
        seg = seg.permute(2, 0, 1)

        # Apply transforms, including resizing, if provided
        if self.transform:
